...
This package contains data types only — no behavior, no `node:*` imports. It is safe to import from Node, the browser, Cloudflare Workers, or any other JS runtime.
